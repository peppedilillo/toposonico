...
This monorepo contains all code used for Hummap (codename: sick), a recommender and navigable map for 17M discographic entities. The project is structured in three main sections:
