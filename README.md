...
This monorepo contains all code used for toposonico.com (codename: sick), a recommender and navigable map for music tracks, artists, albums and labels. The project is structured in three main sections:
