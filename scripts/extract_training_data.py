...
SELECT
    ...
    t.duration_ms, t.track_number, t.disc_number, al.total_tracks
FROM tracks AS t
...
def main():
    ...
    df = pd.read_sql_query(QUERY, conn, params=[args.popularity])
    conn.close()
    ...
    output_path = output_dir / f"training_pop{args.popularity}.parquet"
