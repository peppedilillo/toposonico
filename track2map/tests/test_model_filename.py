...
def test_make_model_filename():
    assert (
        ...
        == "model_pure_bolt_t5M_ep8_v1d4128.pt"
    )
    assert (
        make_model_filename("vivid_dragon", 47_000_000, 12, 0.9461)
        == "model_vivid_dragon_t47M_ep12_v0d9461.pt"
    )
    assert (
        make_model_filename("calm_fox", 1_000_000_000, 1, 2.0)
        == "model_calm_fox_t1B_ep1_v2d0000.pt"
    )
    assert (
        make_model_filename("calm_fox", 500, 1, 2.0)
        == "model_calm_fox_t500_ep1_v2d0000.pt"
    )
...
def test_extract_run_name():
    ...
    assert (
        extract_run_name("/some/path/model_vivid_dragon_t47M_ep12_v0d9461.pt")
        == "vivid_dragon"
    )
