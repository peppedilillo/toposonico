...
def filter_cascade(
    track: pd.DataFrame,
    filter_track: Callable[[pd.DataFrame], pd.DataFrame],
    album: pd.DataFrame,
    filter_album: Callable[[pd.DataFrame], pd.DataFrame],
    artist: pd.DataFrame,
    filter_artist: Callable[[pd.DataFrame], pd.DataFrame],
    label: pd.DataFrame,
    filter_label: Callable[[pd.DataFrame], pd.DataFrame],
) -> EntityTable:
