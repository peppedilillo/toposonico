...
export function TrackSummary({trackName, artist, album, debugId}: TrackSummaryProps) {
  return (
...
export function AlbumSummary({albumName, artist, debugId}: AlbumSummaryProps) {
  return (
    <div className="space-y-1.5">
...
export function ArtistSummary({artistName, genre, playlistCount, debugId}: ArtistSummaryProps) {
  return (
    <div className="space-y-1.5">
      ...
      <div className="text-sm text-muted leading-tight truncate">
        {genre ? <>{genre} · {playlistCount}</> : playlistCount}
      </div>
    </div>
  )
}
...
export function LabelSummary({labelName, playlistCount, debugId}: LabelSummaryProps) {
  return (
    <div className="space-y-1.5">
      ...
      <div className="text-sm text-muted leading-tight truncate">{playlistCount}</div>
    </div>
  )
}
